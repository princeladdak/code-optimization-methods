...
* __KISS it, simpler can be faster__  :  Keep it simple [3], makes various other techniques easier to apply and modify.
...
* __Divide into subproblems and Conquer the solution__ : Subproblems can be easier/faster to solve and combine for the global solution. Sorting algorithms are great examples of that. [4]
